      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <NavLink to="/opportunities" className="text-gray-700 hover:text-green-700 font-medium transition-colors">
              Opportunities
            </NavLink>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col space-y-4">
              ...
              <NavLink to="/opportunities" className="text-gray-700 hover:text-green-600 font-medium transition-colors">
                Opportunities
              </NavLink>
              {isAuthenticated() ? (
                <button 
