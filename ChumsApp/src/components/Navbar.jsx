...
const Navbar = () => {
  ...
  return (
 <header className="bg-white shadow-primary border-b border-gray-100 sticky top-0 z-50">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col space-y-4">
              ...
              <NavLink to="/insights" className="text-gray-700 hover:text-primary font-medium transition-colors">
                Market Insights
              </NavLink>
              {isAuthenticated() ? (
                <button 
